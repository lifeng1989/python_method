...
def compute_ninggudu(word, freq, freq_limit):
    ...
    if length == 2:
        word1, word2 = word
        ninggudu = w_freq / (freq.get(word1, freq_limit)*freq.get(word2, freq_limit))*sum
    elif length == 3:
        word1, word2 = word[:2], word[2:3]
        ninggudu1 = w_freq / (freq.get(word1, freq_limit)*freq.get(word2, freq_limit))*sum
        word1, word2 = word[:1], word[1:3]
        ninggudu2 = w_freq / (freq.get(word1, freq_limit)*freq.get(word2, freq_limit))*sum
        ...
        ninggudu3 = w_freq / (freq.get(word1, freq_limit)*freq.get(word2, freq_limit))*sum
